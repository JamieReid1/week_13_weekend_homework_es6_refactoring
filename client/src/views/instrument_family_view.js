...
class InstrumentFamilyView {
  ...
  render(family) {
    let properties = {name: family.name, description: family.description, instruments: family.instruments};
    let {name: name, description: description, instruments: instruments} = properties;
